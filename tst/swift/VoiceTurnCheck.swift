...
@main struct VoiceTurnCheck {
    static func main() {
        ...
        precondition(voicePause("How quickly") == 3.0)
        precondition(voicePause("This complete thought has enough words to hand off promptly") == 1.4)
        precondition(voicePause(String(repeating: "more words ", count: 12)) == 1.65)
        precondition(keepListeningCommand("not done"))
        precondition(keepListeningCommand("Keep listening."))
        precondition(!keepListeningCommand("keep listening to the radio"))
