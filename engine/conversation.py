...
class Conversation:
    ...
    def latest_segment(self):
        return self.map.row(
            ...
            " where device = %s and runtime = %s and runtime_policy_version = 6 and runtime_session_id is not null"
    ...
    def open_segment(self, mode):
        return self.map.value(
            "insert into memory.conversations (agent, device, runtime, runtime_policy_version) values (%s, %s, %s, 6) returning id",
