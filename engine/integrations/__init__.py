...
def read_specs(spotify_control=None):
    from engine.integrations.discovery import specs as discovery_specs
    from engine.integrations.linkedin import specs as linkedin_specs
    ...
    return discovery_specs() + linkedin_specs() + web_specs() + news_specs() + specs() + service_specs(spotify_control) + calendar_specs() + [ToolSpec("weather_forecast",
